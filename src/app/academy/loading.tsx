...
export default function AcademyLoading() {
  return (
    <div className="space-y-6">
      <section className="rounded-2xl border border-cyan-200/20 bg-[linear-gradient(135deg,var(--color-panel-bg),var(--color-card-bg))] p-6 sm:p-8 lg:p-10">
        <div className="h-7 w-32 rounded-full bg-white/[0.06]" />
        <div className="mt-6 h-12 max-w-2xl rounded-xl bg-white/[0.06]" />
