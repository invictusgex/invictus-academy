...
type AdminContentResourceCreatePageProps = {
  moduleId: string;
};

export function AdminContentResourceCreatePage({
  moduleId,
}: AdminContentResourceCreatePageProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <AdminContentResourceForm mode="create" module={academyModule} />
    </div>
  );
}
