...
type AdminContentVideoCreatePageProps = {
  moduleId: string;
};

export function AdminContentVideoCreatePage({
  moduleId,
}: AdminContentVideoCreatePageProps) {
    ...
    return (
      <section className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-panel-bg)] p-6 sm:p-8">
        ...
        <p className="mt-4 text-base leading-7 text-[var(--color-text-secondary)]">
          No fue posible cargar el modulo para agregar el video.
        </p>
        <Link
  ...
  return (
    <div className="space-y-6">
      ...
      <AdminContentVideoForm mode="create" module={academyModule} />
    </div>
  );
}
